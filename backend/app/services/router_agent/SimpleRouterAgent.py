...
from app.tracing_services.tracing_decorators import trace_llm_tool_creation
from app.tracing_services.tracing_config import init_tracer, close_parent_span
        ...
        **kwargs: Any,
        ...
        while self.action_plan is None:
            try:
                ...
                retries += 1
                if retries > 3:
                    raise ValueError(f"Invalid action plan selected (Retries : {retries}x)") from e
